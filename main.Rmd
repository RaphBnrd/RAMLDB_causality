...
ggplot_timeseries_one_stock(df[df[[name_id_timeseries]] == this_id, ], variables, 
                            labels_of_variables, id = this_id, time = name_time, scale = TRUE)

# Durations of the timeseries
ggplot_timeseries_durations(df, name_id_timeseries, time = name_time)
```
...
ggplot_simplex_rho_E(res_simplex_tp1, res_simplex_tp1_summary_opti_E, this_id, this_var, labels_of_variables)

# Single variable and method selection E -> histogram of E
this_var = as.character(res_simplex_tp1$variable[1])
this_method = method_select_E_prefered
ggplot_simplex_hist_E(res_simplex_tp1_summary_opti_E, this_var, this_method, labels_of_variables)
...
this_tp = tp_tested_causality[6]
ggplot_convergence_ccm_one_dir(res_ccm_best_E_summaries, this_id, this_causal_rel, this_tp, labels_of_variables)

this_causal_rel = list_of_causality_tested[[3]]
ggplot_convergence_ccm_one_dir(res_ccm_best_E_summaries, this_id, this_causal_rel, this_tp, labels_of_variables)

these_vars = list_of_causality_tested[[1]]

ggplot_convergence_ccm_two_dir(res_ccm_best_E_summaries, this_id, these_vars, this_tp, labels_of_variables)


# Histogram of the causality
id_removed = res_simplex_tp1_summary_opti_E %>% 
...
# At a precise tp
ggplot_ccm_hist_causality_one_tp(res_ccm_best_E_assessment, this_tp, labels_of_variables, 
                                 id_removed = id_removed, list_of_causality_tested = list_of_causality_tested)
ggplot_ccm_alluvial_causality_one_tp_both_dir(res_ccm_best_E_assessment, this_tp, labels_of_variables, 
                                              id_removed = id_removed, list_of_causality_tested = list_of_causality_tested)

# Histograms and flow for multiple tp
these_tp = tp_tested_causality
ggplot_ccm_hist_causality_multiple_tp(res_ccm_best_E_assessment, these_tp, labels_of_variables, 
                                      id_removed = id_removed, list_of_causality_tested = list_of_causality_tested)

ggplot_ccm_alluvial_causality_multiple_tp(res_ccm_best_E_assessment, these_tp, labels_of_variables, 
                                          id_removed = id_removed, list_of_causality_tested = list_of_causality_tested)

# At tp with the maximum rho (assess causality if causality for this tp and tp <= 0)
ggplot_ccm_hist_causality_tp_max_rho(res_ccm_best_E_assessment, labels_of_variables, 
                                     id_removed = id_removed, list_of_causality_tested = list_of_causality_tested)
ggplot_ccm_alluvial_causality_tp_max_rho_both_dir(res_ccm_best_E_assessment, labels_of_variables, 
                                                  id_removed = id_removed, list_of_causality_tested = list_of_causality_tested)

# Compare the methods
ggplot_ccm_alluvial_causality_one_tp_and_tp_max_rho(res_ccm_best_E_assessment, this_tp, labels_of_variables, 
                                                    id_removed = id_removed, list_of_causality_tested = list_of_causality_tested)
...
ggplot_strength_one_stock(res_strength_causality_details_smap, res_strength_causality, this_id, this_causal_rel, this_tp)


# Summary of the strength of the causality (qualitative analysis)
ggplot_strength_summary(res_strength_causality, labels_of_variables, this_tp, list_of_causality_tested)
