...
# Version simplifiée sans polygones et SST
traits_fun <- function(traj_SProd){
  ...
  # To run once because some ERbest are lacking and others do not correspond to
  # TC/TB so at least we know what ERbest2 is!
